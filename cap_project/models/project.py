...
class Project(models.Model):
    ...
    task_vt_ids = fields.One2many(comodel_name='project.task', compute='_compute_task_vt_ids', inverse_name='project_id', store=True)
    task_ch_ids = fields.One2many(comodel_name='project.task', compute='_compute_task_ch_ids', inverse_name='project_id', store=True)
